    ...
    $.post(
      ...
      function (data) {
        if (data.success) {
          ...
          increaseNumberNotification('noti_contact_counter', 1); // js/calculateRequest.js
          increaseNumberNotificationContact('count-request-contact-sent'); // js/calculateRequestContact.js
...
socket.on('response-add-new-contact', function (user) {
  ...
  increaseNumberNotificationContact('count-request-contact-received');
